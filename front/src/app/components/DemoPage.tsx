  ...
  return (
    <div className="h-screen overflow-hidden bg-gray-50">
      <div className="mx-auto flex h-full max-w-[1800px] flex-col px-6 pb-6 pt-3 xl:px-12 xl:pb-12 xl:pt-4">
        ...
        <div className="flex-1 min-h-0 overflow-x-hidden overflow-y-auto pt-6 xl:overflow-y-auto">
          <div className="grid gap-8 xl:h-full xl:min-h-0 xl:grid-cols-[320px_minmax(0,1fr)] xl:items-start">
