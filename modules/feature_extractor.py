diff --git a/D:\项目\计算机设计大赛\modules\feature_extractor.py b/D:\项目\计算机设计大赛\modules\feature_extractor.py
deleted file mode 100644
--- a/D:\项目\计算机设计大赛\modules\feature_extractor.py
+++ /dev/null
@@ -1,187 +0,0 @@
-import functools
-
...
-        )
-    except Exception:
-        # Covers missing tesseract binary and OCR runtime errors.
-        return 0.0
...
-        "contrast": 0.0,
-        "text_density": 0.0,
-        "clip_vector": np.zeros(512, dtype=np.float32),
-        "brightness": 0.0,
-        "saturation": 0.0,
-    }
-
...
-    except Exception:
-        features["clip_vector"] = np.zeros(512, dtype=np.float32)
-
-    try:
